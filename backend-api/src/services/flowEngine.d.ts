...
export declare const clearUserTimers: (botId: string, platformUserId: string) => void;
export declare const executeFlowFromNode: (startNode: any, conversationId: string, botId: string, platformUserId: string, nodes: any[], edges: any[], channel: string, io: any) => Promise<GenericMessage[]>;
